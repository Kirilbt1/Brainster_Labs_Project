...
function hideAllCards() {
    var allCards = document.querySelectorAll(".card-pic");
...
const myButton = document.getElementById("filter-marketing");
myButton.addEventListener("click", function () {
    myButton.style.backgroundColor = "red";
    myButton.innerHTML = '<i class="fas fa-check"></i> Clicked!';
});